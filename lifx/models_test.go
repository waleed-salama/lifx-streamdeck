...
func TestColorSettingsDecode(t *testing.T) {
	...
	require.Equal(t, uint(5000), colorSettings.Color.Kelvin)
	require.Equal(t, uint(5000), colorSettings.Color.Transition)
...
func TestWaveFormSettingsDecode(t *testing.T) {
	...
	require.Equal(t, uint(5000), waveformSettings.AlternateColor.Kelvin)
	require.Equal(t, uint(5000), waveformSettings.AlternateColor.Transition)
	...
	require.Equal(t, -50, waveformSettings.Skew)
